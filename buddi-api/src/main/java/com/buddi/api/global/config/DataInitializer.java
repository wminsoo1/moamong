...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initSearchAliases() {
        ...
        searchAliasRepository.saveAll(List.of(
            ...
            SearchAlias.of("배달의민족", "배달앱", "배달의민족"),
            SearchAlias.of("요기요", "배달앱", "요기요"),
            SearchAlias.of("쿠팡이츠", "배달앱", "쿠팡이츠"),
            ...
            SearchAlias.of("롯데시네마", "영화관", "롯데시네마"),
            SearchAlias.of("메가박스", "영화관", "메가박스"),
            ...
            SearchAlias.of("스타벅스", "카페", "스타벅스"),
            SearchAlias.of("이디야", "카페", "이디야"),
            SearchAlias.of("컴포즈커피", "카페", "컴포즈커피"),
            SearchAlias.of("투썸플레이스", "카페", "투썸플레이스"),
            ...
            SearchAlias.of("세븐일레븐", "편의점", "세븐일레븐"),
            SearchAlias.of("CU", "편의점", "CU"),
            SearchAlias.of("GS25", "편의점", "GS25")
        ));
    }
